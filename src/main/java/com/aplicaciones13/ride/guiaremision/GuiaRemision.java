...
@XmlType(name = "",
         propOrder = { "infoTributaria", "infoGuiaRemision", "destinatarios",
                       "infoAdicional" })
...
public class GuiaRemision {
     ...
     * @return
     * possible object is
     * {@link com.aplicaciones13.ride.guiaremision.InfoTributaria}
     *
     */
    ...
    public static class Destinatarios {
         ...
         * {@link com.aplicaciones13.ride.guiaremision.Destinatario}
         *
         *
         */
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "",
             propOrder = { "dirEstablecimiento", "dirPartida", "razonSocialTransportista",
